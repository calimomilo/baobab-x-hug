    ...
    <AdminLayout title="Nouvelle collecte" desc="Créer une nouvelle collecte.">
        <section id="collect-create" class="relative flex min-h-[calc(100vh-76px)] flex-col items-center justify-start bg-brand-sage-400 font-cooper font-medium py-16 lg:px-40" >
            ...
            <div class="rounded-lg px-6 pt-15 pb-10 bg-white w-full">
                <h1 class="text-xl text-center pb-10 font-bold md:text-4xl">Nouvelle collecte</h1>
                <Form action="/admin/collects" method="post" #default="{ errors, invalid, validate }" class="flex flex-col gap-4 mx-auto max-w-200">
                    <div class="flex gap-4 w-full">
                        <div class="grow">
                            ...
                            <select name="season_year" id="season_year" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent">
                                <option v-for="year, index in seasonsSelect" :key="index" :value="year" :selected="year === currentSeason?.year_of">{{ year }}</option>
                            </select>
                    ...
                    <div class="flex justify-between">
                        <div class="flex gap-4">
                            <div>
                                ...
                                <input type="date" name="date_of" id="date_of" :value="currentDate" :min="currentDate" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('date_of')">
                            ...
                            <div>
                                ...
                                <input type="time" name="start_time" id="start_time" value="09:00" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('start_time')">
                            ...
                            <div>
                                ...
                                <input type="time" name="end_time" id="end_time" value="17:00" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('end_time')">
                        ...
                        <div>
                            ...
                            <input type="number" name="employees" id="employees" value="0" min="0" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('employees')">
                    ...
                    <div class="grow">
                        ...
                        <input type="text" name="location" id="location" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('location')">
                    ...
                    <div class="grow">
                        ...
                        <input type="text" name="appointment_link" id="appointment_link" class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-brand-sage-400 focus:border-transparent" @change="validate('appointment_link')">
